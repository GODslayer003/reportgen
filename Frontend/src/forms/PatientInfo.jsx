      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-12 max-w-[950px] mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-2">Enter the patient's full name:</p>
            <input
              type="text"
              name="patientName"
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-2">Enter the patient's age:</p>
            <input
              type="number"
              name="age"
              value={formData.age}
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-3">Select the patient's sex:</p>
                ...
                <label key={option} className="flex items-center gap-3 cursor-pointer">
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className="
                        w-6 h-6 appearance-none border-2 border-gray-400 rounded-full
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-2">Enter the sample collection date:</p>
            <input
              type="date"
              name="collectionDate"
        ...
        <div className="flex justify-end mt-12">
          <button
            onClick={handleNext}
            className="px-12 py-3 bg-[#4A9B94] text-white rounded-lg text-base font-medium hover:bg-[#3d8580]"
          >
            Next
          </button>
        </div>
